        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          ...
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="logo" href="<?php echo base_url();?>" title="HomeBidPro"><img alt="home" src="<?php echo base_url();?>media/img/logo.png"></a>
                 ...
                 <ul class="dropdown-menu"> 
                  ...
                  <li class="divider" role="separator"></li> 
                          ...
                          <li>
                           ...
                           <li>
                              <a href="<?php echo base_url();?>homeowner/profile" title="Profile">Profile</a>
                            </li>
