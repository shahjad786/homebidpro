...
<th class="header ">Exporation</th>
<th class="header ">Budget</th>
<th class="header ">Bids</th>
<th class="header ">My Bids</th>
<th class="header ">Lowest Bids</th>
...
<tr >
  ...
  <td>
  <?php if($value['price']) { echo "$".$value['price'];}?>
   </td>
  <td>
  <?php echo  $value['bids'];?>
   </td>
  ...
  <?php } ?>
   ...
   <td>
  <?php if($value['minbid']) { echo  "$".$value['minbid'] ;}?>
   </td>
  <td>
...
<tr>
<th class="header">Name</th>
<th class="header ">Award Date</th>
<th class="header ">Bid Amount</th>
...
<tr>
  ...
  <td>
  <a onclick="return Confirmclose();" href="<?php echo base_url();?>contractor/jobs/update_complete_status?job_bid_id=<?php echo $value['job_bid_id']; ?>&job_id=<?php echo $value['id'];?>"><button class="btn-small btn-white enabled_button">CLOSE</button></a>
  </td>
</tr>
...
<?php if($myreview && count($myreview)>0) {




if($myreview[0]['status']==1)
{
...
<?php if($review['rating'] && $review['status']==1) { ?>
<fieldset class="rating">
<table class="demo-table">
<tbody>
<tr>
