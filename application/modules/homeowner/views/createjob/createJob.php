 ...
 <div class="container"> 
  ...
  <?php  if($this->session->userdata('logged_in')) 
   ...
   <?php } } ?>
        ...
        <div id="loginbox"   class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 fullwidthsection">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" >
                           <form id ="newjob" name ="homeowner" class="form-horizontal" role="form" action="<?php echo base_url();?>homeowner/createjob/insert_job" enctype="multipart/form-data" method="POST">
                                     ...
                                     <div class="col-md-9">
                                            <select class="form-control input-sm" id = "job_category" name="job_category">
                                                ...
                                                { 
                                                 ...
                                                 echo '<option value = "' . $row->id . '" ' . (in_array($row->id,$category_id) ? 'selected="selected"' : '') . '>' . $row->job_category . '</option>';                    
